...
An unofficial CLI tool to scaffold a new [**electron-vite**](https://electron-vite.org/) project in seconds, with templates for your preferred frontend framework, various optional integrations, and essential configuration files.
